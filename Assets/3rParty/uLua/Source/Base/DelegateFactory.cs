...
public static class DelegateFactory
{
	...
	public static void Register(IntPtr L)
	{
		...
		dict.Add(typeof(UnityEngine.Events.UnityAction<UnityEngine.SceneManagement.Scene,UnityEngine.SceneManagement.LoadSceneMode>), new DelegateValue(UnityAction_UnityEngine_SceneManagement_Scene_UnityEngine_SceneManagement_LoadSceneMode));
		dict.Add(typeof(UnityEngine.Events.UnityAction<UnityEngine.SceneManagement.Scene>), new DelegateValue(UnityAction_UnityEngine_SceneManagement_Scene));
		dict.Add(typeof(UnityEngine.Events.UnityAction<UnityEngine.SceneManagement.Scene,UnityEngine.SceneManagement.Scene>), new DelegateValue(UnityAction_UnityEngine_SceneManagement_Scene_UnityEngine_SceneManagement_Scene));
		dict.Add(typeof(Action<EasyAR.ImageTargetBaseBehaviour>), new DelegateValue(Action_EasyAR_ImageTargetBaseBehaviour));
		dict.Add(typeof(Action<EasyAR.ImageTargetBaseBehaviour,EasyAR.ImageTrackerBaseBehaviour,bool>), new DelegateValue(Action_EasyAR_ImageTargetBaseBehaviour_EasyAR_ImageTrackerBaseBehaviour_bool));
	}
	...
	public static Delegate UnityAction_UnityEngine_SceneManagement_Scene_UnityEngine_SceneManagement_LoadSceneMode(LuaFunction func)
	{
		UnityEngine.Events.UnityAction<UnityEngine.SceneManagement.Scene,UnityEngine.SceneManagement.LoadSceneMode> d = (param0, param1) =>
		{
			int top = func.BeginPCall();
			IntPtr L = func.GetLuaState();
	...
	public static Delegate UnityAction_UnityEngine_SceneManagement_Scene(LuaFunction func)
	{
		UnityEngine.Events.UnityAction<UnityEngine.SceneManagement.Scene> d = (param0) =>
		{
			int top = func.BeginPCall();
			IntPtr L = func.GetLuaState();
			LuaScriptMgr.PushValue(L, param0);
	...
	public static Delegate UnityAction_UnityEngine_SceneManagement_Scene_UnityEngine_SceneManagement_Scene(LuaFunction func)
	{
		UnityEngine.Events.UnityAction<UnityEngine.SceneManagement.Scene,UnityEngine.SceneManagement.Scene> d = (param0, param1) =>
		{
			int top = func.BeginPCall();
			IntPtr L = func.GetLuaState();
			LuaScriptMgr.PushValue(L, param0);
	...
	public static Delegate Action_EasyAR_ImageTargetBaseBehaviour(LuaFunction func)
	{
		Action<EasyAR.ImageTargetBaseBehaviour> d = (param0) =>
		{
			int top = func.BeginPCall();
			IntPtr L = func.GetLuaState();
			LuaScriptMgr.Push(L, param0);
	...
	public static Delegate Action_EasyAR_ImageTargetBaseBehaviour_EasyAR_ImageTrackerBaseBehaviour_bool(LuaFunction func)
	{
		Action<EasyAR.ImageTargetBaseBehaviour,EasyAR.ImageTrackerBaseBehaviour,bool> d = (param0, param1, param2) =>
		{
			int top = func.BeginPCall();
			IntPtr L = func.GetLuaState();
			LuaScriptMgr.Push(L, param0);
