...
public class UnityEngine_SceneManagement_SceneManagerWrap
{
	...
	static int UnloadScene(IntPtr L)
	{
		...
		if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(UnityEngine.SceneManagement.Scene)))
		{
			UnityEngine.SceneManagement.Scene arg0 = (UnityEngine.SceneManagement.Scene)LuaScriptMgr.GetLuaObject(L, 1);
