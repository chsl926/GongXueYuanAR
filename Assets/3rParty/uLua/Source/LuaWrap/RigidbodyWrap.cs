...
public class RigidbodyWrap
{
	public static void Register(IntPtr L)
	{
		...
		LuaField[] fields = new LuaField[]
		{
			...
			new LuaField("solverIterations", get_solverIterations, set_solverIterations),
			new LuaField("solverVelocityIterations", get_solverVelocityIterations, set_solverVelocityIterations),
	...
	static int get_solverIterations(IntPtr L)
	{
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name solverIterations");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index solverIterations on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.solverIterations);
		return 1;
	}
	...
	static int get_solverVelocityIterations(IntPtr L)
	{
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name solverVelocityIterations");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index solverVelocityIterations on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.solverVelocityIterations);
		return 1;
	}
	...
	static int set_solverIterations(IntPtr L)
	{
		...
		obj.solverIterations = (int)LuaScriptMgr.GetNumber(L, 3);
		return 0;
	}
	...
	static int set_solverVelocityIterations(IntPtr L)
	{
		...
		obj.solverVelocityIterations = (int)LuaScriptMgr.GetNumber(L, 3);
		return 0;
	}
