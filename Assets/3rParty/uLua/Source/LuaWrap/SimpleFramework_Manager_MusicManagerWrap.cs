...
public class SimpleFramework_Manager_MusicManagerWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("PlayPos", PlayPos),
			new LuaMethod("PlayObj", PlayObj),
			new LuaMethod("PauseObj", PauseObj),
			new LuaMethod("StopObj", StopObj),
			new LuaMethod("PlayBG", PlayBG),
			new LuaMethod("PauseBG", PauseBG),
			new LuaMethod("StopBG", StopBG),
	...
	static int PlayObj(IntPtr L)
	{
		...
		obj.PlayObj(arg0,arg1,arg2);
		return 0;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int PauseObj(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 2);
		SimpleFramework.Manager.MusicManager obj = (SimpleFramework.Manager.MusicManager)LuaScriptMgr.GetUnityObjectSelf(L, 1, "SimpleFramework.Manager.MusicManager");
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int PlayBG(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 3);
		SimpleFramework.Manager.MusicManager obj = (SimpleFramework.Manager.MusicManager)LuaScriptMgr.GetUnityObjectSelf(L, 1, "SimpleFramework.Manager.MusicManager");
		string arg0 = LuaScriptMgr.GetLuaString(L, 2);
		bool arg1 = LuaScriptMgr.GetBoolean(L, 3);
		obj.PlayBG(arg0,arg1);
		return 0;
	}
