...
public class Packager {
    ...
    [MenuItem("Packager/Build iPhone Resource", false, 11)]
    ...
    [MenuItem("Packager/Build Android Resource", false, 12)]
    public static void BuildAndroidResource() {
        BuildAssetResource(BuildTarget.Android, true); 
    }

    [MenuItem("Packager/Build Windows Resource", false, 13)]
    ...
    [MenuItem("Packager/Build Protobuf-lua-gen File")]
