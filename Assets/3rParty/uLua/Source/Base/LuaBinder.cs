...
public static class LuaBinder
{
	...
	public static void Bind(IntPtr L, string type = null)
	{
		...
		switch (type) {
			...
			case "EasyAR_EasyImageTargetBehaviourWrap": EasyAR_EasyImageTargetBehaviourWrap.Register(L); break;
			case "EasyAR_ImageTargetBaseBehaviourWrap": EasyAR_ImageTargetBaseBehaviourWrap.Register(L); break;
			case "EasyAR_ImageTargetBehaviourWrap": EasyAR_ImageTargetBehaviourWrap.Register(L); break;
			case "EnumWrap": EnumWrap.Register(L); break;
			case "ETCJoystickWrap": ETCJoystickWrap.Register(L); break;
			case "GameObjectWrap": GameObjectWrap.Register(L); break;
			case "GUIDebugWrap": GUIDebugWrap.Register(L); break;
			...
			case "SimpleFramework_ColliderEventWrap": SimpleFramework_ColliderEventWrap.Register(L); break;
