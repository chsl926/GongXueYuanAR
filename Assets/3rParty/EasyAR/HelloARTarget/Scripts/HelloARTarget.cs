...
namespace EasyARSample
{
    public class HelloARTarget : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            targetBehaviour.SetupWithImage("sightplus/argame01.jpg", StorageType.App, "argame01", new Vector2());
            ...
            targetBehaviour.Bind(tracker);
            targetBehaviour.SetupWithJsonFile("targets.json", StorageType.App, "argame");
