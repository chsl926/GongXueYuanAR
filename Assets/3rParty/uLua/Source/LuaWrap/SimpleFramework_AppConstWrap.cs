...
public class SimpleFramework_AppConstWrap
{
	public static void Register(IntPtr L)
	{
		...
		LuaField[] fields = new LuaField[]
		{
			...
			new LuaField("TestMode", get_TestMode, null),
			...
			new LuaField("strAccessId", get_strAccessId, set_strAccessId),
			new LuaField("strAccessKey", get_strAccessKey, set_strAccessKey),
			new LuaField("iBuckName", get_iBuckName, set_iBuckName),
			new LuaField("iBuckUpdate", get_iBuckUpdate, set_iBuckUpdate),
			new LuaField("strArea", get_strArea, set_strArea),
			new LuaField("CurSceneName", get_CurSceneName, set_CurSceneName),
	...
	{
		LuaScriptMgr.Push(L, SimpleFramework.AppConst.TestMode);
		return 1;
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_strAccessId(IntPtr L)
	{
		LuaScriptMgr.Push(L, SimpleFramework.AppConst.strAccessId);
		return 1;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_strAccessKey(IntPtr L)
	{
		LuaScriptMgr.Push(L, SimpleFramework.AppConst.strAccessKey);
		return 1;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_iBuckName(IntPtr L)
	{
		LuaScriptMgr.Push(L, SimpleFramework.AppConst.iBuckName);
		return 1;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_iBuckUpdate(IntPtr L)
	{
		LuaScriptMgr.Push(L, SimpleFramework.AppConst.iBuckUpdate);
		return 1;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_strArea(IntPtr L)
	{
		LuaScriptMgr.Push(L, SimpleFramework.AppConst.strArea);
		return 1;
	}
	...
	{
		LuaScriptMgr.Push(L, SimpleFramework.AppConst.CurSceneName);
		return 1;
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_strAccessId(IntPtr L)
	{
		SimpleFramework.AppConst.strAccessId = LuaScriptMgr.GetString(L, 3);
		return 0;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_strAccessKey(IntPtr L)
	{
		SimpleFramework.AppConst.strAccessKey = LuaScriptMgr.GetString(L, 3);
		return 0;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_iBuckName(IntPtr L)
	{
		SimpleFramework.AppConst.iBuckName = LuaScriptMgr.GetString(L, 3);
		return 0;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_iBuckUpdate(IntPtr L)
	{
		SimpleFramework.AppConst.iBuckUpdate = LuaScriptMgr.GetString(L, 3);
		return 0;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_strArea(IntPtr L)
	{
		SimpleFramework.AppConst.strArea = LuaScriptMgr.GetString(L, 3);
		return 0;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_CurSceneName(IntPtr L)
	{
		SimpleFramework.AppConst.CurSceneName = LuaScriptMgr.GetString(L, 3);
		return 0;
	}
}
