...
public static class WrapFile {
    ...
    public static BindType[] binds = new BindType[]
    {
        ...
        _GT(typeof(ColliderEvent)),
        _GT(typeof(Rigidbody)),

        

         //easyAR 
        //_GT(typeof(ARBuilder)),
        //_GT(typeof(AugmenterBehaviour)),
        //_GT(typeof(BarCodeScannerBehaviour)),
        //_GT(typeof(CameraDeviceBehaviour)),
        
        _GT(typeof(ImageTargetBaseBehaviour)),
        _GT(typeof(ImageTargetBehaviour)),
        _GT(typeof(EasyImageTargetBehaviour)),

        //_GT(typeof(StorageType)),
        //_GT(typeof(EasyARBehaviour)),
        //_GT(typeof(ImageTrackerBehaviour)),
        //_GT(typeof(RealityPlaneBehaviour)),
        //_GT(typeof(RenderCameraBehaviour)),
        //_GT(typeof(VideoPlayerBehaviour)),
