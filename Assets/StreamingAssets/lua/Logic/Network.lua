...
function Network.Start() 
    ...
    netEvent.AddListener(Connect, this.OnConnect); 
    netEvent.AddListener(Login, this.OnLogin); 
    netEvent.AddListener(Exception, this.OnException); 
    netEvent.AddListener(Disconnect, this.OnDisconnect); 
end

--Socket消息--
function Network.OnSocket(key, data)
    netEvent.Brocast(tostring(key), data);
end
...
function Network.Unload()
    netEvent.RemoveListener(Connect);
    netEvent.RemoveListener(Login);
    netEvent.RemoveListener(Exception);
    netEvent.RemoveListener(Disconnect);
